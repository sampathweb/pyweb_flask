...
class MicroBlogTestCase(unittest.TestCase):
    ...
    def test_login_logout(self):
        ...
        self.assertTrue('You were logged in' in response.data)
        # verify we can log back out
        response = self.logout()
        self.assertTrue('You were logged out' in response.data)
        # verify that incorrect credentials get a proper message
        response = self.login('notadmin', 'secret')
        self.assertTrue('Invalid Login' in response.data)
    ...
    def test_empty_listings(self):
        ...
        self.assertTrue('No entries here so far' in response.data)
